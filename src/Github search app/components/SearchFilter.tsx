    ...
    <div className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl mx-auto mb-6 sm:mb-8 px-4 sm:px-0">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 sm:pl-12 pr-4 sm:pr-6 py-3 sm:py-4 text-base sm:text-lg bg-gray-800 border border-gray-700 rounded-xl sm:rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder:text-gray-500 text-white"
        />
      </div>
    </div>
  )
